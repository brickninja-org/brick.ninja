...
export const ExternalLink: FC<ExternalLinkProps> = ({ href, target, children }) => {
  ...
  return (
    <a href={href} target={target} rel="noopener noreferrer" className="group focus-visible:outline-(--color-focus) hover:decoration-transparent">
      ...
      <span className="whitespace-nowrap">&#8203;<Icon icon="arrow-up-right"/></span>
    </a>
  );
};
