...
const radio = tv({
  slots: {
    base: 'inline-flex flex-row items-center gap-2 rounded-sm py-2 px-4 leading-5 cursor-pointer hover:bg-accent-soft focus-visible:outline-hidden',
    input: 'hidden',
  ...
  variants: {
    checked: {
      true: {
        circle: 'border-accent bg-accent',
      }
    }
  }
});
