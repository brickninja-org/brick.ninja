...
import { fetchBricklinkApi, FetchOptions } from '@bricklink-api/fetch/src';
import { EndpointType, KnownEndpoint, OptionsByEndpoint } from '@bricklink-api/types/endpoints';
...
export async function fetchApi<Url extends KnownEndpoint | NonNullable<string>>(
  ...
  try {
    return await fetchBricklinkApi<Url, SchemaVersion>(url, {
      schema,
