export type Type = 'Book' | 'Minifigure' | 'Set' | 'Consumable' | 'Container' | 'CraftingMaterial' | 'Gathering' | 'Gizmo' | 'JadeTechModule' | 'Key' | 'MiniPet' | 'PowerCore' | 'Relic' | 'Tool' | 'Trait' | 'Trinket' | 'Trophy' | 'UpgradeComponent' | 'Weapon';
export type SubType<T extends Type> =
  T extends 'Book' ? 'Magazine' | 'Coat' | 'Gloves' | 'Helm' | 'HelmAquatic' | 'Leggings' | 'Shoulders' :
...
export type TypeWithSubtype = 'Book' | 'Consumable' | 'Container' | 'Gathering' | 'Gizmo' | 'Tool' | 'Trinket' | 'UpgradeComponent' | 'Weapon';
