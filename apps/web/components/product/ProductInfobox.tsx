...
export const ProductInfobox: FC<ProductInfoboxProps> = ({ product, data, language }) => {
  ...
  return (
    <div>
      ...
      <FlexRow wrap>
        ...
        <ShareButton className="flex-1 rounded-sm" variant="tertiary" data={{ title: localizedName(product, language), url: `/product/${product.id}` }}/>
      </FlexRow>
    </div>
  );
};
