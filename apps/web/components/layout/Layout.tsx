    ...
    <div>
      <div className="layout grid min-h-dvh">
        <Menu navigation={<Navigation language={language}/>}>
          <Link href="/" aria-label="brick.ninja" className="group relative flex items-center gap-4 mr-8 font-bitter font-bold text-xl text-foreground no-underline transition-transform">
