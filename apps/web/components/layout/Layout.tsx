  ...
  return (
    <div>
      <div className="layout grid min-h-dvh">
        ...
        <hr className="[grid-area:menuShadow] sticky block top-12 h-px bg-transparent z-2"/>
        {children}
        <footer className="[grid-area:footer] flex justify-between gap-4 flex-wrap py-8 px-4 border-t border-border">
      ...
      <div className="w-full p-4 border-t border-border text-sm text-muted" data-nosnippet>
