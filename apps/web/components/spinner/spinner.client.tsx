...
interface SpinnerPrimitiveProps extends React.SVGProps<SVGSVGElement>, RefProp<SVGSVGElement> {}

const SpinnerPrimitive: FC<SpinnerPrimitiveProps> = ({ ref, ...props }) => {
  const id = useId();
...
interface SpinnerProps extends RefProp<SVGSVGElement>, Omit<ComponentPropsWithoutRef<'svg'>, 'display' | 'opacity' | 'color'>, SpinnerVariants {}

const Spinner: FC<SpinnerProps> = ({ className, color, size, ref, ...props }) => {
  return (
    <span
      data-spinner
...
Spinner.displayName = 'BrickCatalog.Spinner';
