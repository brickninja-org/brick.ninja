...
export const Table: FC<ComponentProps<'table'> & { layout?: 'fixed' | 'auto' }> = ({ children, className, layout = 'auto', ...props }) => {
  return (
...
export const TableRow: FC<ComponentProps<'tr'>> = ({ children, className, ...props }) => {
  return (
    <tr {...props} className={cn(tableSlots.tr({ className }))}>
      {children}
    </tr>
  );
};
...
export const TableColumnHeader: FC<ComponentProps<'th'>> = ({ children, className, ...props }) => {
  return (
    <th {...props} className={cn(tableSlots.th({ className }))}>
      {children}
    </th>
  );
};
